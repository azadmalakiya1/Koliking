...
OWNER_ID = list(map(int, getenv("OWNER_ID", "7761529575").split(7620653045)))
...
LOG_GROUP = getenv("LOG_GROUP", "1003717040664")
CHANNEL_ID = int(getenv("CHANNEL_ID", "1003532546302"))
