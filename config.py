...
API_ID = int(getenv("API_ID", "27625650"))
API_HASH = getenv("API_HASH", "5c4fe37d859e63edaf2975bc3c2b9e81")
BOT_TOKEN = getenv("BOT_TOKEN", "")
OWNER_ID = list(map(int, getenv("OWNER_ID", "6571435026").split()))
...
LOG_GROUP = getenv("LOG_GROUP", "-5504444919")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1004412586581"))
