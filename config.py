...
API_ID = int(getenv("API_ID", "30094068"))
API_HASH = getenv("API_HASH", "fccdb95518d2b853628f00341a5909c2")
BOT_TOKEN = getenv("BOT_TOKEN", "")
OWNER_ID = list(map(int, getenv("OWNER_ID", "8375285761").split()))
...
LOG_GROUP = getenv("LOG_GROUP", "-1003568257327")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1003685744472"))
